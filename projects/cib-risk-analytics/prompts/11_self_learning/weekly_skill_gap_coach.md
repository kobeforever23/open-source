# Weekly Skill Gap Coach
**Category:** 11_self_learning
**AS-OF:** 2026-03-05 13:24:30 EST

## Objective
Generate weekly learning priorities from role and performance gaps.
...
Task objective: Generate weekly learning priorities from role and performance gaps.
...
- **Decision lens:** retention quality
...
| KPI alignment | No KPI linkage | One KPI linked | `practice throughput` and `promotion-readiness score` clearly monitored |
