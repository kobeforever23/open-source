# CIB Risk OS Master Operator
**Category:** 00_system
**AS-OF:** 2026-03-05 13:24:30 EST

## Objective
Run any CIB risk workflow with citation, control, and decision discipline.
...
Task objective: Run any CIB risk workflow with citation, control, and decision discipline.
...
- **Decision lens:** platform governance
...
| KPI alignment | No KPI linkage | One KPI linked | `use-case intake quality` and `control gate pass rate` clearly monitored |
