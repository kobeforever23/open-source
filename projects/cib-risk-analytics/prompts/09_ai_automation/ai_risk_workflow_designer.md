# AI Risk Workflow Designer
**Category:** 09_ai_automation
**AS-OF:** 2026-03-05 13:24:30 EST

## Objective
Design human-in-the-loop AI workflows for risk operations.
...
Task objective: Design human-in-the-loop AI workflows for risk operations.
...
- **Decision lens:** groundedness rate
...
| KPI alignment | No KPI linkage | One KPI linked | `approval gate compliance` and `replayability completeness` clearly monitored |
