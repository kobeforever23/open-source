# Wrong-Way Risk Investigation
**Category:** 03_credit_ccr
**AS-OF:** 2026-03-05 13:24:30 EST

## Objective
Investigate potential wrong-way risk concentration and controls.
...
Task objective: Investigate potential wrong-way risk concentration and controls.
...
- **Decision lens:** exposure realism
...
| KPI alignment | No KPI linkage | One KPI linked | `collateral effectiveness` and `counterparty concentration stability` clearly monitored |
