# Regulatory Stress Mapping
**Category:** 05_capital_stress
**AS-OF:** 2026-03-05 13:24:30 EST

## Objective
Map regulatory stress scenarios to internal portfolios and controls.
...
Task objective: Map regulatory stress scenarios to internal portfolios and controls.
...
| KPI alignment | No KPI linkage | One KPI linked | `ratio attribution precision` and `buffer management quality` clearly monitored |
