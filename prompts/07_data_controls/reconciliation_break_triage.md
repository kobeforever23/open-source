# Reconciliation Break Triage
**Category:** 07_data_controls
**AS-OF:** 2026-03-05 13:24:30 EST

## Objective
Triage reconciliations, classify severity, assign remediation owners.
...
Task objective: Triage reconciliations, classify severity, assign remediation owners.
...
- **Decision lens:** data defect density
...
| KPI alignment | No KPI linkage | One KPI linked | `break closure SLA` and `control test success` clearly monitored |
