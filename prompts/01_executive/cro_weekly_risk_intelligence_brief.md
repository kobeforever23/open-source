# CRO Weekly Risk Intelligence Brief
**Category:** 01_executive
**AS-OF:** 2026-03-05 13:24:30 EST

## Objective
Generate weekly CRO risk brief with cross-asset, cross-risk synthesis.
...
Task objective: Generate weekly CRO risk brief with cross-asset, cross-risk synthesis.
...
- **Decision lens:** executive decision quality
...
| KPI alignment | No KPI linkage | One KPI linked | `top-risk clarity score` and `action closure rate` clearly monitored |
